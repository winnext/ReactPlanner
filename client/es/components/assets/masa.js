  ...
  return {
    ...
    render2D: function render2D(element, layer, scene) {
      ...
      return React.createElement(
        ...
        props.image ? React.createElement('image', { key: '2', x: '0', y: '0', width: newWidth, height: newDepth, preserveAspectRatio: 'none', transform: 'translate(0, ' + newDepth + ') scale(1,-1) rotate(' + textRotation + ')', href: props.image }) : null
      );
    },
