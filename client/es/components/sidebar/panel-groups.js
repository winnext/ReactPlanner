...
import { FaTrash, FaEye, FaLink, FaUnlink } from
// FaAbacus
'react-icons/fa';
          ...
          React.createElement(
            ...
            groups.entrySeq().map(function (_ref) {
              ...
              var swapVisibility = function swapVisibility(e) {
                ...
                _this2.context.groupsActions.setGroupAttributes(groupID, new Map({ visible: !visibleValue }));
                    ...
                    layers.map(function (layerTemp) {
                      layerTemp.get('items').map(function (itemTemp) {
                        if (itemTemp.get('id') === item) {
                          _this2.context.itemsActions.setItemAttributes(item, layerTemp.get('id'), new Map({ visible: !visibleValue }));
                        }
                      });
                    });
                  });
