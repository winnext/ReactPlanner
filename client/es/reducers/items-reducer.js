...
import { SELECT_TOOL_DRAWING_ITEM, SET_ITEMS_ITEM_ATTRIBUTES, UPDATE_DRAWING_ITEM, END_DRAWING_ITEM, BEGIN_DRAGGING_ITEM, UPDATE_DRAGGING_ITEM, END_DRAGGING_ITEM, BEGIN_ROTATING_ITEM, UPDATE_ROTATING_ITEM, END_ROTATING_ITEM, SELECT_ITEM, CREATE_ITEM } from "../constants";
...
export default function (state, action) {
  switch (action.type) {
    ...
    case SET_ITEMS_ITEM_ATTRIBUTES:
      return Item.setAttributes(state, action.layerID, action.itemID, action.attributes).updatedState;
