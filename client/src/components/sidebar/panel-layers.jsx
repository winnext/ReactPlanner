  ...
  render() {
    ...
    return (
      <Panel name={this.context.translator.t("Layers")}>
        ...
        <p style={newLayerLableStyle} onClick={(e)=>{
          this.props.showLayersColors.setShowLayersColors((prevValue) => {
          ...
          <FaEye
            style={
              this.props.showLayersColors.showLayersColors
              ? styleEyeVisible
              : styleEyeHidden
            }
          />
            <b style={styleAddLabel}>Colors</b>
        </p>
