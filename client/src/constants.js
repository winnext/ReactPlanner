...
export const OPEN_PROJECT_BACKGROUND = 'OPEN_PROJECT_BACKGROUND';
export const OPEN_TODO = 'OPEN_TODO';
export const OPEN_MODEL_UPLOAD = 'OPEN_MODEL_UPLOAD';
...
export const MODE_VIEWING_ASSETS = 'MODE_VIEWING_ASSETS';
export const MODE_CONFIGURING_PROJECT = 'MODE_CONFIGURING_PROJECT';
export const MODE_CONFIGURING_BACKGROUND = 'MODE_CONFIGURING_BACKGROUND';
export const MODE_TODO = 'MODE_TODO';
export const MODE_MODEL_UPLOAD = 'MODE_MODEL_UPLOAD';
