...
var _catologAddItem = require("./catolog-add-item");

var _catologAddItem2 = _interopRequireDefault(_catologAddItem);
...
var CatalogList = function (_Component) {
  ...
  _createClass(CatalogList, [{
    ...
    value: function render() {
      ...
      var turnBackButton = pathSize > 0 ? _react2.default.createElement(_catalogTurnBackPageItem2.default, {
        key: pathSize,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.matchString === "" ? [turnBackButton, categoriesToDisplay.map(function (cat) {
            if (cat.name === "Add Item") return _react2.default.createElement(_catologAddItem2.default, {
              key: cat.name,
              page: { name: "Add Item", label: "Add Item" },
              oldPage: currentCategory
            });
            if (cat.name === "assets") return;
            return _react2.default.createElement(_catalogPageItem2.default, {
              key: cat.name,
              page: cat,
              oldPage: currentCategory
            });
          ...
          currentCategory.label === "Add Item" && _react2.default.createElement(_AddItem2.default, null)
        )
      );
    }
  }]);
