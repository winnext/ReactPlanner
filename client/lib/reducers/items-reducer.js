...
exports.default = function (state, action) {
  switch (action.type) {
    case _constants.CREATE_ITEM:
      return _export.Item.create(state, action.layerID, action.componentType, action.x, action.y, action.width, action.height, action.rotation, action.info).updatedState;

    case _constants.SELECT_ITEM:
      return _export.Item.select(state, action.layerID, action.itemID).updatedState;

    case _constants.SET_ITEMS_ITEM_ATTRIBUTES:
      return _export.Item.setAttributes(state, action.layerID, action.itemID, action.attributes).updatedState;
