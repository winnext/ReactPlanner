...
var Item = function () {
  ...
  _createClass(Item, null, [{
    ...
    value: function create(state, layerID, type, x, y, width, height, rotation) {
      var info = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : {};
    ...
    value: function endDraggingItem(state, x, y) {
      ...
      if (startArea !== endArea) {
        ...
        var selectedItem = state.scene.getIn(["layers", layerID, "items", itemID]).toJS();
        _axios2.default.post("http://localhost:9001/plan/moveComponent", {
